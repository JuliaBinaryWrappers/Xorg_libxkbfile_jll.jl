...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libxkbfile_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("cc61e674-0454-545c-8b26-ed2c68acab7a"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_libxkbfile; unsupported platform $(triplet(platform_key_abi()))")
else
